var url_shim = (function () {
  ...
  a=a instanceof Uint8Array?a:a.buffer instanceof ArrayBuffer?new Uint8Array(a.buffer):new Uint8Array(a);return p(a)};l.TextEncoder=m;l.TextDecoder=k;})("undefined"!==typeof window?window:"undefined"!==typeof global$1?global$1:undefined);
  ...
  var require$$0 = /*@__PURE__*/getAugmentedNamespace(punycode$2);
  ...
  function percentDecodeBytes$2(input) {
  ...
  function percentDecodeString$1(input) {
    const bytes = utf8Encode$1(input);
    return percentDecodeBytes$2(bytes);
  }
  ...
  var percentEncoding$1 = {
    ...
    percentDecodeString: percentDecodeString$1,
    percentDecodeBytes: percentDecodeBytes$2,
  ...
  const { percentDecodeString, utf8PercentEncodeCodePoint, utf8PercentEncodeString, isC0ControlPercentEncode,
    ...
    isUserinfoPercentEncode } = percentEncoding$1;
  ...
  const { percentDecodeBytes: percentDecodeBytes$1, utf8PercentEncodeString, isURLEncodedPercentEncode } = percentEncoding$1;
  ...
  function parseUrlencoded(input) {
    ...
    for (const bytes of sequences) {
      ...
      const nameString = utf8DecodeWithoutBOM(percentDecodeBytes$1(name));
      const valueString = utf8DecodeWithoutBOM(percentDecodeBytes$1(value));
  ...
  const Impl = URLSearchParamsImpl;
  }(URLSearchParams$3));

  const usm = urlStateMachine$1.exports;
  const urlencoded = urlencoded$2;
  const URLSearchParams$2 = URLSearchParams$3;
  ...
  URLImpl.implementation = class URLImpl {
    constructor(globalObject, constructorArgs) {
      ...
      this._query = URLSearchParams$2.createImpl(globalObject, [query], { doNotStripQMark: true });
  ...
  const URL$2 = URL$3;
  const URLSearchParams$1 = URLSearchParams$3;

  webidl2jsWrapper.URL = URL$2;
  webidl2jsWrapper.URLSearchParams = URLSearchParams$1;

  const { URL: URL$1, URLSearchParams } = webidl2jsWrapper;
  const urlStateMachine = urlStateMachine$1.exports;
  const percentEncoding = percentEncoding$1;

  const sharedGlobalObject = { Array, Object, Promise, String, TypeError };
  URL$1.install(sharedGlobalObject, ["Window"]);
  URLSearchParams.install(sharedGlobalObject, ["Window"]);

  var URL_1 = whatwgUrl.URL = sharedGlobalObject.URL;
  var URLSearchParams_1 = whatwgUrl.URLSearchParams = sharedGlobalObject.URLSearchParams;

  var parseURL = whatwgUrl.parseURL = urlStateMachine.parseURL;
  var basicURLParse = whatwgUrl.basicURLParse = urlStateMachine.basicURLParse;
  var serializeURL = whatwgUrl.serializeURL = urlStateMachine.serializeURL;
  var serializePath = whatwgUrl.serializePath = urlStateMachine.serializePath;
  var serializeHost = whatwgUrl.serializeHost = urlStateMachine.serializeHost;
  var serializeInteger = whatwgUrl.serializeInteger = urlStateMachine.serializeInteger;
  var serializeURLOrigin = whatwgUrl.serializeURLOrigin = urlStateMachine.serializeURLOrigin;
  var setTheUsername = whatwgUrl.setTheUsername = urlStateMachine.setTheUsername;
  var setThePassword = whatwgUrl.setThePassword = urlStateMachine.setThePassword;
  var cannotHaveAUsernamePasswordPort = whatwgUrl.cannotHaveAUsernamePasswordPort = urlStateMachine.cannotHaveAUsernamePasswordPort;
  var hasAnOpaquePath = whatwgUrl.hasAnOpaquePath = urlStateMachine.hasAnOpaquePath;

  var percentDecodeString = whatwgUrl.percentDecodeString = percentEncoding.percentDecodeString;
  var percentDecodeBytes = whatwgUrl.percentDecodeBytes = percentEncoding.percentDecodeBytes;

  var url = /*#__PURE__*/Object.freeze(/*#__PURE__*/_mergeNamespaces({
    __proto__: null,
    'default': whatwgUrl,
    URL: URL_1,
    ...
    hasAnOpaquePath: hasAnOpaquePath,
